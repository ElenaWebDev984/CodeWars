...
function Dad(){
  ...
  return d1 + a2 + d2; // "D" + "a" + "d" 
}
function Bee(){
  //select some variable to combine "Bee"
  return b1 + e2 + e2; // "B" + "e" + "e"
}
function banana(){
  //select some variable to combine "banana"
  return b2 + a2 + n2 + a2 + n2 + a2; // "b" + "a" + "n" + "a" + "n" + "a"
}

//answer some questions if you finished works above
function answer1(){
  //the answer should be "yes" or "no"
  return "no"; // or "no", based on the actual question
}
function answer2(){
  //the answer should be "yes" or "no"
  return "no"; // or "no", based on the actual question
...
function answer3(){
  //the answer should be "yes" or "no"
  return "yes"; // or "no", based on the actual question
}
